#!/bin/bash
# 更新训练代码以使用官方 MineCLIP 和 data/attn.pth

set -e

echo "========================================"
echo "更新训练代码使用 MineCLIP"
echo "========================================"
echo ""
...
echo "  ✓ 备份到 train_get_wood.py.bak"
echo ""
...
echo ""
echo "文件说明:"
echo "  - train_get_wood.py.bak  ← 原文件备份"
echo "  - train_get_wood_v2.py   ← 新版本（使用MineCLIP）"
echo "  - train_get_wood.py      ← 当前版本（未变）"
echo ""
