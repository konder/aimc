#!/bin/bash
# This will resume training if data/training_checkpoint is not empty. 
# If you want to start from scratch, delete the directory.
...
--out_weights "$PROJECT_ROOT/data/weights/steve1/trained_with_script.weights" \
--trunc_t 64 \
--T 640 \
--batch_size 12 \
...
--min_btwn_goals 15 \
--max_btwn_goals 200 \
--checkpoint_dir "$PROJECT_ROOT/data/training_checkpoint" \
--val_freq 1000 \
--val_freq_begin 100 \
